...
builder.Services.AddObservability<IFrontendCustomerOrderStatusObservability, FrontendCustomerOrderStatusObservability>(observabilityOptions, options => new FrontendCustomerOrderStatusObservability(options.ServiceName, options.ServiceName));
