...
builder.Services.AddObservability<IFrontendKitchenMonitorObservability, FrontendKitchenMonitorObservability>(observabilityOptions, options => new FrontendKitchenMonitorObservability(options.ServiceName, options.ServiceName));
